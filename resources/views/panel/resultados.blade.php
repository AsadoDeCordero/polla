        ...
        <div class="latest-result">
            <div class="container">
                ...
                <!--
                    ...
                    -->
                     <div class="col-xl-6 col-lg-6" id="divpartido->partido_id">
                        <div class="single-match">
                            <div class="part-head">
                                <h5 class="match-title">partido->titulo</h5>
                            </div>
                            <div class="part-team">
                                <input type="hidden" name="partido_id" id="partidopartido->partido_id" value="partido->partido_id">
                                <div class="single-team win-team">
                                    <div class="logo">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Flag_of_Germany.svg/1920px-Flag_of_Germany.svg.png" alt="">
                                    </div>
                                ...
                                <div class="single-team">
                                    <div class="logo">
                                        ...
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Flag_of_Australia_%28converted%29.svg/1920px-Flag_of_Australia_%28converted%29.svg.png" alt="">
                                    </div>
                                    <span class="team-name">partido->visita</span>
                                </div>
                            </div>
                            <div class="col-md-12" style="text-align:center;padding: 0px;">
                                <a id="boton_partido->partido_id" onclick="return null;" class="btn btn-danger" style="background: #dc3545;cursor: default;width:100%;color:white"> Tu apuesta <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Flag_of_Germany.svg/1920px-Flag_of_Germany.svg.png" style="height: 15px;"> 0 - 0 <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Flag_of_Australia_%28converted%29.svg/1920px-Flag_of_Australia_%28converted%29.svg.png" style="height: 15px;"></a>
                            </div>
                        </div>
                    </div>
